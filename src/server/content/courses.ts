...
export const courseLessons: LessonEntry[] = [
  ...
  },
  {
    ...
    contentKind: "markdown",
    title: "Windows 桌面版 Claude Code 怎样接入 API",
    description: "在 Claude Desktop 中接入 DeepSeek 或兼容中转站，并通过只读任务验证连接、能力和安全边界。",
    audience: "建议年龄 10—14 岁",
    readingTime: "预计学习 25—30 分钟",
    sections: [
      { id: "动手前准备好这三样东西", label: "动手前，准备好这三样东西" },
      { id: "这条连接到底连了什么", label: "这条连接到底连了什么" },
      { id: "第一步打开第三方推理配置", label: "第一步：打开第三方推理配置" },
      { id: "第二步填写-deepseek-官方-api", label: "第二步：填写 DeepSeek 官方 API" },
      { id: "第三步选一个模型来试", label: "第三步：选一个模型来试" },
      { id: "第四步从只读任务开始验证", label: "第四步：从只读任务开始验证" },
      { id: "deepseek-接入后有哪些能力差异", label: "DeepSeek 接入后有哪些能力差异" },
      { id: "换成其他中转站先问清七件事", label: "换成其他中转站，先问清七件事" },
      { id: "常见错误怎样排查", label: "常见错误怎样排查" },
